...
// connect to database
$db = mysqli_connect("localhost", "root", "", "farmingwebsite");
...
function register(){
	...
	if (count($errors) == 0) {
		...
		if (isset($_POST['user_type'])) {
			...
			$query = "INSERT INTO users (username, address, telephone, email, password, user_type) VALUES ('$username', '$address', '$telephone', '$email', '$password', '$user_type')";
